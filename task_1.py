...
today = Data('06 - 05 - 2021')
print(today)
print(Data.valid(17, 15, 2023))
print(today.valid(8, 8, 2015))
print(Data.extract('14 - 4 - 2014'))
print(today.extract('06 - 05 - 2021'))
print(Data.valid(20, 12, 2021))
